...
export const trendingMediaListItems: TMediaListItem[] = [
  {
    ...
    title: "Today",
    callback: async () => await api.tmdb.trending.getList("day"),
  },
  {
    id: "8c31b4a3-0ed1-422c-b0c9-aaefc6743c27",
    title: "This Week",
    callback: async () => await api.tmdb.trending.getList("week"),
  },
];
...
export const popularMediaListItems: TMediaListItem[] = [
  {
    ...
    title: "Streaming",
    callback: async () => await api.tmdb.movie.getPopular(),
  },
  {
    id: "53a183eb-cf95-4bac-b88b-d2efdf364b76",
    title: "On TV",
    callback: async () => await api.tmdb.tv.getPopular(),
  },
];
